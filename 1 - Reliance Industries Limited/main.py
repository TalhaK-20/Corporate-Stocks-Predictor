...
data = pd.read_excel('data/Reliance.xlsx')
print(data.head())
...
joblib.dump(open_price_column, os.path.join(model_dir, 'reliance_stock_price_open_model.pkl'))
joblib.dump(high, os.path.join(model_dir, 'reliance_stock_price_high_model.pkl'))
joblib.dump(low, os.path.join(model_dir, 'reliance_stock_price_low_model.pkl'))
joblib.dump(close, os.path.join(model_dir, 'reliance_stock_price_close_model.pkl'))


# ------------------------ Loading Models from Files ------------------------

loaded_model_open = joblib.load(os.path.join(model_dir, 'reliance_stock_price_open_model.pkl'))
loaded_model_high = joblib.load(os.path.join(model_dir, 'reliance_stock_price_high_model.pkl'))
loaded_model_low = joblib.load(os.path.join(model_dir, 'reliance_stock_price_low_model.pkl'))
loaded_model_close = joblib.load(os.path.join(model_dir, 'reliance_stock_price_close_model.pkl'))
